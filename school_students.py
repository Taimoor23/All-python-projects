...
df=pd.read_csv('C:/Users/Bajwa/Downloads/School2.csv')
...
fig_2.show()
dtf=pd.read_csv('C:/Users/Bajwa/Downloads/School_1_Sample.csv')
...
fig_2.add_trace(go.Scatter(x=[third_std_deviation_end,third_std_deviation_end],y=[0,0.17],mode='lines',name='Standard deviation 3'))
fig_2.show()
dtf_2=pd.read_csv('C:/Users/Bajwa/Downloads/School_2_Sample.csv')
...
fig_2.add_trace(go.Scatter(x=[third_std_deviation_end,third_std_deviation_end],y=[0,0.17],mode='lines',name='Standard deviation 3'))
fig_2.show()
dtf_3=pd.read_csv('C:/Users/Bajwa/Downloads/School_3_Sample.csv')
